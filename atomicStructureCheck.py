...
def scan_atoms():
    ...
    forbidden_patterns = [
        r"import\s+\w+\s+from\s+['\"]@/components/atoms/[^'\"]+['\"]",
        r"import\s+\w+\s+from\s+['\"]@/components/molecules/[^'\"]+['\"]",
        r"import\s+\w+\s+from\s+['\"]@/components/organisms/[^'\"]+['\"]",
        r"import\s+\w+\s+from\s+['\"]@/components/templates/[^'\"]+['\"]",
...
def scan_molecules():
    ...
    forbidden_patterns = [
        ...
        r"import\s+\w+\s+from\s+['\"]@/components/organisms/[^'\"]+['\"]",
        r"import\s+\w+\s+from\s+['\"]@/components/templates/[^'\"]+['\"]",
        r"import\s+\w+\s+from\s+['\"]@/components/[^'\"]+/[^'\"]+/components/[^'\"]+['\"]",
        r"import\s+\w+\s+from\s+['\"]\.\./\.\./atoms/[^'\"]+['\"]"
    ]
...
def scan_organisms():
    ...
    forbidden_patterns = [
        ...
        r"import\s+\w+\s+from\s+['\"]@/components/templates/[^'\"]+['\"]",
        r"import\s+\w+\s+from\s+['\"]@/components/[^'\"]+/[^'\"]+/components/[^'\"]+['\"]",
        r"import\s+\w+\s+from\s+['\"]\.\./\.\./molecules/[^'\"]+['\"]",
        r"import\s+\w+\s+from\s+['\"]\.\./\.\./atoms/[^'\"]+['\"]"
    ]
