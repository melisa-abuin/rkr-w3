  ...
  return (
    <ColumnsWrapper>
      ...
      <Column>
        ...
        <ColumnText>
          Playing together makes everything more exciting! In this map, you and
          your friends can tackle challenges that are impossible to beat alone.
          Team up to overcome obstacles, support each other, and achieve victory
          as a group.
        </ColumnText>
      </Column>
      <Column>
